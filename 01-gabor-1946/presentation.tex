...
\begin{frame}
	...
	\begin{figure}
		\vspace{-1em}
		\centering
		\subfloat[Good $\Delta t$, bad $\Delta f$]{{\includegraphics[width=5cm]{./stft_small.png} }}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\subfloat[Good $\Delta t$, bad $\Delta f$]{{\includegraphics[width=5cm]{./stft_small_zoomed.png} }}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\subfloat[Gausswin]{{\includegraphics[width=5cm]{./gaborstft_small_zoomed.png} }}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\subfloat[Gausswin]{{\includegraphics[width=5.2cm]{./gaborstft_big_zoomed.png} }}
